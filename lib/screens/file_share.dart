...
class _FileTransferPageState extends State<FileTransferPage> {
  ...
  Future<void> _receiveFiles() async {
    ...
    final saveDir = await FilePicker.platform.getDirectoryPath(dialogTitle: "Select Folder to Save Files");
    if (saveDir != null) {
      await FileReceiver.downloadMultipleFiles(_selectedServer!.wifiIP, saveDir);
      if (mounted) {
